...
export default function Header() {
    ...
    return (        
        <section className="ultimate-quick-view-for-woocommerce-header">
            <Container fluid="fluid">
                <div className="topbar-part bg-dark-blue">
                    <div className="text-center">
                    {__('You\'re Using', 'ultimate-quick-view-for-woocommerce')} <strong>{data.name}</strong> <span className="d-inline-block text-lite-blue">{__('Free Version', 'ultimate-quick-view-for-woocommerce')}</span>                          
                    </div>
                </div>
            </Container>
            <Container fluid="fluid">
    ...
    return (
        <ul className="list-inline">
            <li className="list-inline-item" /*onClick={(e) => { fn(e, 'welcome') }}*/>
                ...
                >{__('Welcome', 'ultimate-quick-view-for-woocommerce')}</NavLink>
            </li>
            <li className="list-inline-item" /*onClick={(e) => { fn(e, 'settings') }}*/>
                <NavLink 
                    ...
                    >{__('Settings', 'ultimate-quick-view-for-woocommerce')}</NavLink>
            </li>
        </ul>
    );
}
